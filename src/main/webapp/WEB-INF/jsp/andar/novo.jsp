...
<head>
  ...
  <title>Novo Andar - Chamados</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Novo Andar</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div class="container-fluid">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Cadastro em lote do andar</h3>
          </div>
          <form method="post" action="<c:url value='/blocos/${andar.blocoId}/andares'/>">
            <div class="card-body">
              <div class="form-group">
                <label for="numero">Número do andar</label>
                <input id="numero" name="numero" type="number" min="1" class="form-control" required>
              </div>
              <div class="form-group">
            ...
            <div class="card-footer">
              <button type="submit" class="btn btn-primary">Salvar e gerar andar</button>
              <a href="<c:url value='/blocos/${andar.blocoId}'/>" class="btn btn-secondary">Cancelar</a>
            </div>
          </form>
        </div>
      </div>
